    ...
    <main className="container mx-auto py-8 px-4 max-w-3xl">
      ...
      <div className="mb-10">
        <div className="flex items-center gap-2 mb-4">
          <span role="img" aria-label="van" className="text-2xl">🚐</span>
          <h1 className="text-3xl font-bold">Be-Loved Scheduler Overview</h1>
        </div>
      ...
      <div className="mb-8">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="text-2xl font-bold">Multi-User System</h2>
        </div>
      ...
      <div className="mb-8">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="text-2xl font-bold">Core Ride Scheduling Features</h2>
        </div>
      ...
      <div className="mb-8">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="text-2xl font-bold">Administrative Features</h2>
        </div>
