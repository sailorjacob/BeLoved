...
// Create a custom animated section component
const AnimatedSection = ({ children, className = "", delay = 0 }: {
  ...
  return (
    <motion.div
      ...
      animate={inView ? { opacity: 1, scale: 1, z: 0 } : { opacity: 0, scale: 0.95, z: -50 }}
      transition={{ 
        duration: 0.8, 
        delay, 
        ease: [0.22, 1, 0.36, 1] 
...
export default function AboutPage() {
  ...
  // Prevent hydration errors by mounting animations only after client-side rendering
  useEffect(() => {
    setIsMounted(true)
  }, [])
    ...
    <main className="container mx-auto py-16 px-4 max-w-3xl">
      ...
      {isMounted ? (
        <>
          ...
          <AnimatedSection className="mb-10" delay={0.6}>
            <div className="flex items-center gap-3 mb-4">
          ...
          <AnimatedSection className="mb-10" delay={0.7}>
            <div className="flex items-center gap-3 mb-4">
          ...
          <AnimatedSection className="mb-10" delay={0.8}>
