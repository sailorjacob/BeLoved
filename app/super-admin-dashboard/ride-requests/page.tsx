...
import { SuperAdminRideRequests } from '@/app/components/super-admin-ride-requests'
import Image from 'next/image'
import { UserNav } from '@/app/components/user-nav'
import { Button } from '@/components/ui/button'

export default function SuperAdminRideRequestsPage() {
  ...
  return (
    <main className="container mx-auto p-4">
      ...
      <h2 className="text-2xl font-bold mb-6">Ride Requests Management</h2>
      
      <SuperAdminRideRequests />
    </main>
  )
} 