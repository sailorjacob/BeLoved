  ...
  useEffect(() => {
    ...
    if (!authLoading) {
      ...
      if (role !== 'super_admin' && role !== 'admin') {
        const dashboardPath = role === 'driver' 
          ? '/driver-dashboard'
          : '/member-dashboard'
      ...
      // If we got here, user is logged in as admin or super_admin
      ...
      <div className="container mx-auto p-4">
        <div className="flex justify-between items-center mb-8">
          ...
          <Button variant="outline" asChild>
            <Link href={`/super-admin-dashboard/members/${params.id}`}>
              Back to Member
            </Link>
          </Button>
        </div>
    ...
    <main className="container mx-auto p-4">
      <div className="flex justify-between items-center mb-8">
        ...
        <div className="flex items-center gap-4">
          <Button variant="outline" asChild>
            <Link href={`/super-admin-dashboard/members/${params.id}`} className="flex items-center gap-2">
              <ArrowLeft size={16} />
              Back to Profile
            </Link>
          </Button>
                    ...
                    <tr key={ride.id} className="border-t">
                      ...
                      <td className="p-4 text-right">
                        <Button variant="outline" size="sm" asChild>
                          <Link href={`/super-admin-dashboard/rides/${ride.id}`}>
                            View Details
                          </Link>
                        </Button>
                      </td>
