    ...
    <main className="container mx-auto p-4 py-8 max-w-4xl">
      ...
      <div className="prose max-w-none">
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          ...
          <li>
            <p><strong>Application</strong> refers to BeLoved, the software program provided by the Company.</p>
          </li>
          <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to BeLoved Transportation.</p>
          </li>
          <li>
          ...
          <li>
            <p><strong>Website</strong> refers to BeLoved Transportation, accessible from <a href="https://be-loved.app" rel="external nofollow noopener" target="_blank">https://be-loved.app</a></p>
          </li>
          <li>
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          ...
          <li><p>Medical Information: Medicaid ID (if applicable), appointment details (provider name, address, time)</p></li>
          <li><p>Service Information: Trip IDs, pickup and dropoff locations, scheduled times</p></li>
          <li><p>Driver Information: For drivers, we collect license information and vehicle details</p></li>
        ...
        <h4 className="text-lg font-bold mt-4 mb-2">Information Collected while Using the Application</h4>
        <p>While using Our Application, in order to provide features of Our Application, We may collect, with Your prior permission:</p>
        <ul className="list-disc pl-6 space-y-2 my-4">
          <li><p>Information regarding your location</p></li>
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          ...
          <li><p><strong>To schedule and confirm rides:</strong> To verify eligibility and contact you about trips.</p></li>
          <li><p><strong>To confirm appointments:</strong> To verify with medical providers.</p></li>
          <li><p><strong>To ensure safety:</strong> To ensure the safety and security of our users and drivers.</p></li>
        ...
        <ul className="list-disc pl-6 space-y-2 my-4">
          ...
          <li><strong>With Drivers:</strong> Limited information (name, address, Trip ID) to facilitate pickups.</li>
          <li><strong>With Medical Providers:</strong> To confirm appointments and verify medical necessity.</li>
        ...
        <h3 className="text-xl font-bold mt-6 mb-3">Retention of Your Personal Data</h3>
        ...
        <h3 className="text-xl font-bold mt-6 mb-3">Transfer of Your Personal Data</h3>
        ...
        <h3 className="text-xl font-bold mt-6 mb-3">Data Storage and Security</h3>
        ...
        <h3 className="text-xl font-bold mt-6 mb-3">Delete Your Personal Data</h3>
        ...
        <h3 className="text-xl font-bold mt-6 mb-3">Disclosure of Your Personal Data</h3>
        ...
        <h3 className="text-xl font-bold mt-6 mb-3">Security of Your Personal Data</h3>
