  ...
  return (
    <main className="container mx-auto p-4 py-8 max-w-4xl">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">Last updated: April 12, 2025</p>
      </div>
      ...
      <div className="prose max-w-none">
        ...
        <ul>
          <li><p>By email: privacy@belovedtransportation.com</p></li>
          <li><p>By visiting this page on our website: <a href="https://be-loved.app/contact" rel="external nofollow noopener" target="_blank">https://be-loved.app/contact</a></p></li>
          <li><p>By phone number: 1-800-555-1234</p></li>
